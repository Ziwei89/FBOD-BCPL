...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--data_root_path', default="/home/ziwei/ziweiwork/dataset/FBD-SV-2024/", type=str,
        ...
        self.parser.add_argument('--data_augmentation', action='store_true',
